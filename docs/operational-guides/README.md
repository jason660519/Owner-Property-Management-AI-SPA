...
> 本目錄收錄「如何執行某項操作」的步驟、流程與規範，供開發者與 AI 協作時參考。
...
- **操作指南**：需具體可執行步驟或檢查清單（如 SOP、quick start、runbook）。
- **非操作類**：架構說明、技術選型、實作計畫、設計規範等請放在 `implementation-plans/`、`technical-selection/`、`design-guidelines/` 等目錄。

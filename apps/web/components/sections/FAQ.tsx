...
const faqItems: FAQItem[] = [
    ...
    },
    {
        id: '3',
        question: '服務有哪些收費方案？',
        answer: '房屋廣告一律免費。付費方案為 1 組「房客管理 + 合約管理」99 元/月。無隱藏費用，可隨時升級或降級。',
    },
    {
        id: '4',
    ...
    },
    {
        id: '6',
        question: '如何聯繫客服支援？',
        answer: '您可以透過多種方式聯繫我們：AI 即時對話、電子郵件 (a0405142777@gmail.com)、電話 (+61) 405 142 777 或填寫網站上的聯絡表單。我們的客服團隊會在 24 小時內回覆您的問題。',
    },
];

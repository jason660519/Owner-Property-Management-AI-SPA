 ...
 * 基於 Figma 設計的圖標組件
 */
export function Icon({ name, size = 'md', color = 'white', className }: IconProps) {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-6 h-6',
    lg: 'w-8 h-8',
  ...
  const icons = {
    'bed': (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 8V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2m14 0v6a2 2 0 01-2 2H6a2 2 0 01-2-2V8m14 0V6a2 2 0 00-2-2h-2M4 8h16M4 16h16" />
      </svg>
    ),
    'bath': (
      <svg className={classes} fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
"[project]/apps/superadmin/app/superadmin/dashboard/role_access_matrix/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RoleAccessMatrixPage() {
    ...
    if ($[0] !== "cf587cf871eb9eaa04a285e877ea1964cf78484eff17a74b34c377ce1735c735") {
        for(let $i = 0; $i < 69; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "cf587cf871eb9eaa04a285e877ea1964cf78484eff17a74b34c377ce1735c735";
    }
    const [matrix, setMatrix] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(INITIAL_MATRIX);
    ...
    let t0;
    if ($[1] !== searchQuery) {
        t0 = MOCK_RESOURCES.filter({
            "RoleAccessMatrixPage[MOCK_RESOURCES.filter()]": (res)=>res.name.toLowerCase().includes(searchQuery.toLowerCase()) || res.category.toLowerCase().includes(searchQuery.toLowerCase())
        }["RoleAccessMatrixPage[MOCK_RESOURCES.filter()]"]);
        $[1] = searchQuery;
        $[2] = t0;
    } else {
        t0 = $[2];
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "RoleAccessMatrixPage[togglePermission]": (roleId, resourceId)=>{
                setMatrix({
                    "RoleAccessMatrixPage[togglePermission > setMatrix()]": (prev)=>{
                ...
                }["RoleAccessMatrixPage[togglePermission > setMatrix()]"]);
                setHasUnsavedChanges(true);
            }
        })["RoleAccessMatrixPage[togglePermission]"];
        $[3] = t1;
    } else {
        t1 = $[3];
    }
    const togglePermission = t1;
    const getPermissionIcon = _RoleAccessMatrixPageGetPermissionIcon;
    const getPermissionLabel = _RoleAccessMatrixPageGetPermissionLabel;
    let t2;
    if ($[4] !== matrix) {
        t2 = ({
            "RoleAccessMatrixPage[handleExportJSON]": ()=>{
    ...
    const handleExportJSON = t2;
    let t3;
    if ($[6] !== matrix) {
        t3 = ({
            "RoleAccessMatrixPage[handleExportCSV]": ()=>{
                const header = [
                    "Role",
                    ...MOCK_RESOURCES.map(_RoleAccessMatrixPageHandleExportCSVMOCK_RESOURCESMap)
                ].join(",");
                const rows = MOCK_ROLES.map({
                    "RoleAccessMatrixPage[handleExportCSV > MOCK_ROLES.map()]": (role)=>{
                        const perms = MOCK_RESOURCES.map({
                            "RoleAccessMatrixPage[handleExportCSV > MOCK_ROLES.map() > MOCK_RESOURCES.map()]": (res_0)=>matrix[role.id]?.[res_0.id] || "deny"
                        }["RoleAccessMatrixPage[handleExportCSV > MOCK_ROLES.map() > MOCK_RESOURCES.map()]"]);
                        return [
                            role.name,
                            ...perms
                        ].join(",");
                    }
                }["RoleAccessMatrixPage[handleExportCSV > MOCK_ROLES.map()]"]);
    ...
    const handleExportCSV = t3;
    let t4;
    if ($[8] !== hasUnsavedChanges) {
        t4 = ({
            "RoleAccessMatrixPage[handleSaveClick]": ()=>{
    ...
    const handleSaveClick = t4;
    let t5;
    if ($[10] !== matrix) {
        t5 = ({
            "RoleAccessMatrixPage[handleConfirmSave]": ()=>{
        ...
        t6 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                    ...
                    children: "Role Access Matrix"
                }, void 0, false, {
                    fileName: "[project]/apps/superadmin/app/superadmin/dashboard/role_access_matrix/page.tsx",
                    lineNumber: 241,
                    columnNumber: 15
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-sm text-gray-500 mt-1",
                    children: "Manage role-based access control for system resources."
                }, void 0, false, {
                    fileName: "[project]/apps/superadmin/app/superadmin/dashboard/role_access_matrix/page.tsx",
                    lineNumber: 241,
                    columnNumber: 87
    ...
    if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            onClick: _RoleAccessMatrixPageButtonOnClick,
            children: [
                t7,
                " Import",
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                    ...
                    className: "hidden",
                    accept: ".json",
                    onChange: _RoleAccessMatrixPageInputOnChange
                }, void 0, false, {
                    fileName: "[project]/apps/superadmin/app/superadmin/dashboard/role_access_matrix/page.tsx",
                    lineNumber: 255,
                    columnNumber: 214
    ...
    const t13 = !hasUnsavedChanges;
    const t14 = hasUnsavedChanges ? "bg-blue-600 text-white hover:bg-blue-700 shadow-sm" : "bg-gray-100 text-gray-400 cursor-not-allowed";
    let t15;
    if ($[21] !== t14) {
        t15 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors", t14);
        $[21] = t14;
        $[22] = t15;
    } else {
        t15 = $[22];
    ...
    let t17;
    if ($[24] !== handleSaveClick || $[25] !== t13 || $[26] !== t15) {
    ...
    if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
        t20 = ({
            "RoleAccessMatrixPage[<input>.onChange]": (e_0)=>setSearchQuery(e_0.target.value)
        })["RoleAccessMatrixPage[<input>.onChange]"];
        $[33] = t20;
    } else {
        t20 = $[33];
    }
    ...
    if ($[42] !== t21) {
        t28 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex flex-col sm:flex-row justify-between items-center mb-4 gap-4 bg-gray-50 p-4 rounded-lg border border-gray-200",
            children: [
                t21,
                t27
            ]
    ...
    if ($[44] === Symbol.for("react.memo_cache_sentinel")) {
        t29 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
            className: "sticky left-0 z-10 bg-gray-50 border-b border-r border-gray-200 p-4 text-left text-sm font-semibold text-gray-700 min-w-[200px]",
            children: "Role / Resource"
        }, void 0, false, {
            fileName: "[project]/apps/superadmin/app/superadmin/dashboard/role_access_matrix/page.tsx",
            lineNumber: 403,
            columnNumber: 11
    ...
    let t30;
    if ($[45] !== filteredResources) {
        t30 = filteredResources.map(_RoleAccessMatrixPageFilteredResourcesMap);
    ...
    let t31;
    if ($[47] !== t30) {
        t31 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
    ...
    let t32;
    if ($[49] !== filteredResources || $[50] !== matrix) {
        t32 = MOCK_ROLES.map({
            "RoleAccessMatrixPage[MOCK_ROLES.map()]": (role_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                    className: "hover:bg-gray-50/50 transition-colors",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                            className: "sticky left-0 z-10 bg-white border-b border-r border-gray-200 p-4 text-sm font-medium text-gray-900",
                        ...
                        filteredResources.map({
                            "RoleAccessMatrixPage[MOCK_ROLES.map() > filteredResources.map()]": (res_2)=>{
                                const state_1 = matrix[role_0.id]?.[res_2.id] || "deny";
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: {
                                            "RoleAccessMatrixPage[MOCK_ROLES.map() > filteredResources.map() > <button>.onClick]": ()=>togglePermission(role_0.id, res_2.id)
                                        }["RoleAccessMatrixPage[MOCK_ROLES.map() > filteredResources.map() > <button>.onClick]"],
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("w-full h-10 rounded-md flex items-center justify-center transition-all duration-200 border", state_1 === "allow" && "bg-green-50 border-green-200 hover:bg-green-100", state_1 === "readonly" && "bg-blue-50 border-blue-200 hover:bg-blue-100", state_1 === "deny" && "bg-red-50 border-red-200 hover:bg-red-100"),
                                        title: `Current: ${getPermissionLabel(state_1)} - Click to change`,
                                        "data-testid": `cell-${role_0.name}-${res_2.name}`,
                                        children: getPermissionIcon(state_1)
                                    }, void 0, false, {
                                        fileName: "[project]/apps/superadmin/app/superadmin/dashboard/role_access_matrix/page.tsx",
                                        lineNumber: 430,
                                        columnNumber: 110
                                    }, this)
                                }, `${role_0.id}-${res_2.id}`, false, {
                                    fileName: "[project]/apps/superadmin/app/superadmin/dashboard/role_access_matrix/page.tsx",
                                    lineNumber: 430,
                                    columnNumber: 20
                                }, this);
                            }
                        }["RoleAccessMatrixPage[MOCK_ROLES.map() > filteredResources.map()]"])
                    ]
                }, role_0.id, true, {
                    fileName: "[project]/apps/superadmin/app/superadmin/dashboard/role_access_matrix/page.tsx",
                    lineNumber: 427,
        ...
        }["RoleAccessMatrixPage[MOCK_ROLES.map()]"]);
        $[49] = filteredResources;
        $[50] = matrix;
        $[51] = t32;
    } else {
        t32 = $[51];
    ...
    let t33;
    if ($[52] !== filteredResources.length || $[53] !== searchQuery) {
        t33 = filteredResources.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                colSpan: MOCK_ROLES.length + 1,
    ...
    let t36;
    if ($[61] !== handleConfirmSave || $[62] !== showConfirmDialog) {
        t36 = showConfirmDialog && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex items-center gap-3 mb-4 text-amber-600",
                        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Are you sure you want to save the changes to the permission matrix? This will immediately affect user access."
                    }, void 0, false, {
                        fileName: "[project]/apps/superadmin/app/superadmin/dashboard/role_access_matrix/page.tsx",
                        lineNumber: 471,
                        columnNumber: 395
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: {
                                    "RoleAccessMatrixPage[<button>.onClick]": ()=>setShowConfirmDialog(false)
                                }["RoleAccessMatrixPage[<button>.onClick]"],
    ...
    let t37;
    if ($[64] !== t18 || $[65] !== t28 || $[66] !== t35 || $[67] !== t36) {
...
_s(RoleAccessMatrixPage, "ht4lNgg7+J0u5/+iVgD63Axpyew=");
_c = RoleAccessMatrixPage;
function _RoleAccessMatrixPageFilteredResourcesMap(res_1) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
        className: "bg-gray-50 border-b border-gray-200 p-4 text-center text-sm font-semibold text-gray-700 min-w-[120px]",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function _RoleAccessMatrixPageInputOnChange(e) {
    const file = e.target.files?.[0];
    if (file) {
        alert(`Importing ${file.name}... (Logic pending)`);
    }
}
function _RoleAccessMatrixPageButtonOnClick() {
    return document.getElementById("import-input")?.click();
}
function _RoleAccessMatrixPageHandleExportCSVMOCK_RESOURCESMap(r) {
    return r.name;
}
function _RoleAccessMatrixPageGetPermissionLabel(state_0) {
    switch(state_0){
        case "allow":
            {
                return "Allow";
...
function _RoleAccessMatrixPageGetPermissionIcon(state) {
    switch(state){
        case "allow":
            {
...
var _c;
__turbopack_context__.k.register(_c, "RoleAccessMatrixPage");
...
//# sourceMappingURL=_e0a8b522._.js.map
// filepath: apps/superadmin/lib/data/taiwan-address.ts
// 台灣縣市、區（鄉鎮市區）對照，供地址下拉選單使用（從大到小：縣市 → 區 → 路/段/街）

/** 縣市 → 區列表 */
export const TAIWAN_CITY_DISTRICTS: Record<string, string[]> = {
  台北市: [
  ...
  台南市: [
    '新營區', '鹽水區', '白河區', '柳營區', '後壁區', '東山區', '麻豆區', '下營區', '六甲區', '官田區', '大內區', '佳里區',
    '學甲區', '西港區', '七股區', '將軍區', '北門區', '新化區', '善化區', '新市區', '安定區', '山上區', '玉井區', '楠西區',
    '南化區', '左鎮區', '仁德區', '歸仁區', '關廟區', '龍崎區', '東區', '南區', '北區', '安南區', '安平區', '中西區',
  ],
  高雄市: [
  ...
  彰化縣: ['彰化市', '鹿港鎮', '和美鎮', '線西鄉', '伸港鄉', '福興鄉', '秀水鄉', '花壇鄉', '芬園鄉', '員林市', '溪湖鎮', '田中鎮', '大村鄉', '埔心鄉', '永靖鄉', '社頭鄉', '二水鄉', '北斗鎮', '二林鎮', '田尾鄉', '埤頭鄉', '芳苑鄉', '大城鄉', '竹塘鄉', '溪州鄉'],

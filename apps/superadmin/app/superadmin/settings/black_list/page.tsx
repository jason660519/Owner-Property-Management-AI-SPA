  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-text-primary">黑名單設定</h1>
          <p className="text-sm text-text-muted mt-1">
            管理被封鎖的 IP / CIDR 與 User-Agent，防止惡意爬蟲與攻擊來源。
          </p>
        </div>
        ...
        <Card variant="outlined" padding="lg" className="mb-8">
          ...
          <CardContent className="space-y-6">
            <form
              onSubmit={handleAdd}
              className="flex flex-wrap items-end gap-4 p-4 rounded-lg bg-bg-tertiary border border-border-light"
            >

...
export interface RoadmapFeature {
  ...
  // --- VIS sync fields ---
  /** VIS issue human-readable ID (e.g. "VIS-136") */
  vis_issue_id?: string;
  /** VIS issue internal UUID */
...
const RAW_FEATURES: RoadmapFeature[] = [
  ...
  },
  {
    ...
    points: 5,
    lastModifiedBy: "DevOps Engineer (VIS-96)",
  ...
  },
  {
    ...
    developmentProgress:
      ...
      "- ✅ lib/ai/anthropic-credit-guard.ts：核心邏輯（loadCreditGuardConfig、getAnthropicSpendUsd、evaluateCreditStatus、runCreditGuardCycle）\n" +

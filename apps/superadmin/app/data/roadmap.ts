...
const RAW_FEATURES: RoadmapFeature[] = [
        ...
        { name: "房東新增物件方式2－自動填入 (VLM/OCR)", locatedPage: "web/landlord/properties/add", percentage: 95, acceptanceCriteria: "1. 上傳物件照片/謄本後，AI 自動擷取物件基本資訊（地址、坪數、格局）。\n2. OCR 準確率需達 85% 以上（在標準文件格式下）。\n3. 自動填入結果可人工校正，顯示原始擷取值與修改後值的對比。\n4. 支援 JPG、PNG、PDF 格式，單檔最大 10MB。\n5. 處理時間 < 30 秒（一般文件）。", docPath: "/project-process/features/vlm-ocr-system.md", featureSpecDocPath: "/project-process/features/vlm-ocr-system.md", tddSpecDocPath: "/project-process/features/tdd-landlord-20260221.md", category: "房東 (Landlord)", points: 8, lastModifiedBy: "", lastModifiedDate: "" },
        ...
        { name: "謄本權狀掃描功能", locatedPage: "web/landlord/properties/add", percentage: 95, acceptanceCriteria: "1. 上傳謄本/權狀文件（JPG、PNG、PDF），系統自動辨識並擷取關鍵資訊。\n2. 擷取資訊包含：地段、地號、面積、所有權人、抵押設定。\n3. OCR 準確率在清晰文件下達 90% 以上。\n4. 擷取結果可人工校正，並儲存至物件資料。\n5. 文件儲存至雲端，可隨時下載原始掃描檔。", docPath: "/project-process/features/vlm-ocr-system.md", featureSpecDocPath: "/project-process/features/vlm-ocr-system.md", tddSpecDocPath: "/project-process/features/tdd-system-common-20260221.md", category: "通用/系統 (General/System)", points: 5, lastModifiedBy: "", lastModifiedDate: "" },

...
export const ROADMAP_DATA: RoadmapData = {
  ...
  features: [
      // ===== 超級管理員 (Super Admin) - 001~010 =====
      {
          ...
          devLog: "【完成項目】\n• KPI 統計卡片已完成，顯示用戶數、物件數、交易金額\n• 圖表視覺化使用 Chart.js 實現\n• Next.js Superadmin App 架構已建立 (Port 3001)\n• 基本 RLS 權限控制已實作\n\n【技術難點】\n• 跨 App 認證同步：透過 Transfer Token 機制解決\n• 權限檢查效能：使用 Supabase RLS + Edge Functions 優化\n\n【下階段計畫】\n• 完善審核事項通知系統\n• 新增日期區間篩選功能"
      },
      {
      ...
      },
      {
          ...
          devLog: "【完成項目】\n• 資料庫 IAM 表格已建立 (roles, permissions, role_permissions)\n• 基礎 API 端點設計完成\n• Superadmin Users 頁面框架建立\n\n【技術難點】\n• 需確保 RBAC 變更即時生效且不影響現有 session\n\n【下階段計畫】\n• 實作完整 CRUD 介面\n• 整合 Audit Log 功能"
      },
      {
          name: "超級管理員-雲端空間管理功能",
          percentage: 90,
          docPath: "/project-process/features/cloud-storage-management.html",
          category: "超級管理員 (Super Admin)",
          startDate: "2026-03-06", endDate: "2026-03-11", owner: "Dev Team", points: 5,
          lastModifiedBy: "Trae AI",
          lastModifiedDate: "2026/02/12",
          acceptanceCriteria: "1. 需顯示目前地端+雲端儲存空間(如S3/Supabase Storage)的總使用量。\n2. 需提供檔案類型分佈統計(圖片、文件、影片)。\n3. 需具備清理過期或未參照檔案(Orphaned Files)的工具。\n4. 管理員可設定單一使用者的上傳配額限制。\n5. 需支援 CDN 流量使用狀況的監控報表。",
          devLog: "【完成項目】\n• 建立 Supabase RPC 函數：get_storage_summary, get_file_type_distribution, identify_orphaned_files\n• 實作 Storage Server Actions\n• 建立 Storage Dashboard UI (Next.js App Router)\n• 孤兒檔案偵測與清理工具\n• 檔案類型分佈視覺化\n\n【技術難點】\n• 跨 schema (public vs storage) 查詢需使用 Security Definer RPC\n• 孤兒檔案判定需關聯多個資料表 (Property_Photos, property_documents)\n\n【下階段計畫】\n• 整合 Supabase Management API 以獲取 CDN 流量數據\n• 完善用戶配額管理介面"
      },
      {
          name: "超級管理員針對 各種Roles的 Access Matrix管理平台",
          percentage: 65,
          docPath: "/project-process/features/iam-system.html",
          category: "超級管理員 (Super Admin)",
          ...
          devLog: "【完成項目】\n• 完整 IAM 資料庫架構已實作 (20260210120000_setup_comprehensive_iam.sql)\n• 角色定義：super_admin, landlord, tenant, buyer, agent 等\n• RLS 策略已部署並測試\n• Access Matrix 設計文件完成\n\n【技術難點】\n• 矩陣式 UI 渲染效能優化\n• 權限繼承邏輯實作\n\n【下階段計畫】\n• 完成前端矩陣 UI 元件\n• 實作 JSON/CSV 匯出入功能"
      },
      {
          name: "超級管理員-資料庫Supabase管理功能",
          percentage: 100,
          docPath: "/project-process/progress-reports/database-reports/supabase-auth-integration-guide.md",
          category: "超級管理員 (Super Admin)",
          ...
          devLog: "【完成項目】\n• Supabase Local Dev 環境完整配置\n• 所有核心表格 Migration 完成 (30+ 個 migration 檔案)\n• RLS 策略全面部署並通過安全性測試\n• Connection Pooling 配置完成\n• 自動備份機制已啟用\n\n【技術難點】\n• RLS 遞迴策略問題已透過 security_definer 函數解決\n• 複雜查詢效能已透過適當索引優化\n\n【已結案】功能開發完成，進入維護階段"
      },
      { 
          name: "超級管理員-資料庫Elastic Search管理功能", 
          percentage: 100, 
          docPath: "/project-process/features/elasticsearch-management.html", 
          category: "超級管理員 (Super Admin)", 
          startDate: "2026-03-27", endDate: "2026-04-01", owner: "Dev Team", points: 5, 
          lastModifiedBy: "Trae AI", 
          lastModifiedDate: "2026/02/12",
          acceptanceCriteria: "1. 中文搜尋準確率需達95%以上，並支援模糊比對與同音字搜尋(簡繁體轉換)。\n2. 搜尋回應時間不超過2秒，確保良好的使用者體驗。\n3. 需建立 PostSQL 與 Elastic Search 資料同步機制，確保資料一致性。\n4. 需可正確識別並計算指定屋主(如:陳XX)名下的所有房地產數量。\n5. 需提供 Elastic Search 叢集健康狀態監控與索引管理功能。",
          devLog: "【完成項目】\n• 建立 Elastic Search 8.12 + IK Analyzer + STConvert 架構\n• 實作 Search Client 與 API (支援模糊搜尋與同音字)\n• 實作資料同步腳本 (PostgreSQL -> ES)\n• 建立 Superadmin ES 管理儀表板 (健康狀態、統計、重建索引)\n• 整合測試通過 (精確度與效能驗證)"
      },
      {
      ...
      // ===== 買家 (Buyer) - 011~013 =====
      {
          name: "買家(已簽約)-儀表板",
          percentage: 55,
          docPath: "/project-process/features/buyer-dashboard-mock-20260206.html",
          category: "買家 (Buyer)",
          ...
          devLog: "【完成項目】\n• Buyer Dashboard 路由與頁面框架建立\n• 已簽約/潛在買家分流設計完成\n• KPI 統計卡片元件整合\n• 與 Landlord Dashboard 共用元件抽離\n\n【技術難點】\n• 多角色切換時的狀態同步\n\n【下階段計畫】\n• 整合行事曆元件\n• 實作待辦事項通知系統"
      },
      {
          name: "買家 - 溝通介面整合 (Buyer Integrations)",
          percentage: 0,
          docPath: "",
          category: "買家 (Buyer)",
          ...
          lastModifiedDate: "2026/02/12",
          acceptanceCriteria: "1. 基於 #079 通用通訊核心系統實作。\n2. 對話紀錄需依「專案」或「物件」進行分組顯示。\n3. 提供買家專屬的快速回覆範本(如：詢問看房時間)。\n4. 整合買家儀表板通知中心。\n5. 介面需針對手機版進行優化。",
          devLog: ""
      },
      {
          name: "買家的繳費記錄",
      ...
      // ===== 公司頁面 (Company Pages) - 014~019 =====
      {
          name: "公司首頁",
          percentage: 90,
          docPath: "/project-process/features/company-homepage.html",
          ...
          devLog: "【完成項目】\n• HeroSection 品牌視覺完成\n• FeaturedProperties 精選物件輪播實作\n• Testimonials 客戶見證區塊\n• FAQ 常見問題區塊\n• Header/Footer 響應式設計\n• SEO Meta Tags 與 OpenGraph 配置\n• 深色主題 UI 設計 (#141414 背景)\n\n【技術難點】\n• 圖片載入優化：使用 Next.js Image + lazy loading\n• 首屏效能優化：達成 LCP < 2.5s\n\n【下階段計畫】\n• 增加動態 CTA 效果\n• A/B 測試不同版面配置"
      },
      {
          name: "公司產品費用說明頁",
          percentage: 0,
      ...
      },
      {
          name: "聯絡我們>發送訊息功能",
          percentage: 100,
          docPath: "/project-process/features/daily-report-20260205.html",
          category: "公司頁面 (Company Pages)",
          ...
          devLog: "【完成項目】\n• Contact 頁面 UI 完成 (深色主題設計)\n• 表單欄位：姓名、Email、電話、詢問類型、訊息內容\n• Server Action sendContactEmail 實作\n• 資料庫 contact_messages 表格建立\n• 表單驗證與錯誤處理\n• 成功/失敗狀態提示\n\n【技術難點】\n• 已解決：表單提交後的狀態管理\n\n【已結案】功能開發完成，進入維護階段"
      },

      // ===== 第三方加值服務 (Third Party) - 020~023 =====
      {
          name: "第三方加值服務－智能門鎖",
          percentage: 0,
          docPath: "",
      ...
      // ===== 房東 (Landlord) - 024~062 =====
      {
          name: "房東-儀表板",
          percentage: 92,
          docPath: "/project-process/features/landlord-dashboard-status-20260206.html",
          ...
          devLog: "【完成項目】\n• KPI 統計卡片：總物件數、出租率、租金收入、待處理事項\n• 物件列表快速概覽\n• 快速新增物件入口\n• 響應式設計 (Mobile/Desktop)\n• Dashboard Layout 元件模組化\n• Server Actions 資料取得\n\n【技術難點】\n• 已解決：KPI 計算效能優化\n• 已解決：多角色儀表板元件共用\n\n【下階段計畫】\n• 財務收支圖表整合\n• 待辦事項通知系統"
      },
      {
          ...
          devLog: "【完成項目】\n• IAM Groups 資料庫架構完成\n• 房東可建立 Property Groups 並指派權限\n• 基礎代理人邀請流程設計\n\n【技術難點】\n• 物件層級權限控制的 RLS 實作較複雜\n\n【下階段計畫】\n• 完成權限範本功能\n• 實作操作歷程記錄"
      },
      {
          name: "房東新增物件方式1－手動輸入",
          percentage: 90,
          docPath: "/project-process/features/landlord-features.html",
          category: "房東 (Landlord)",
          startDate: "2026-03-10", endDate: "2026-03-15", owner: "Dev Team", points: 5,
          lastModifiedBy: "GitHub Copilot",
          lastModifiedDate: "2026/02/11",
          acceptanceCriteria: "1. 需提供完整的表單輸入物件基本資料(地址、坪數、格局)。\n2. 需支援地址自動完成與地圖定位功能。\n3. 必填欄位未填寫時需有明確提示，無法送出。\n4. 需支援暫存草稿功能，避免資料遺失。\n5. 送出後需進行資料格式驗證，並提示新增成功。",
          devLog: "【完成項目】\n• 完整物件表單 UI (PropertyForm.tsx)\n• 表單欄位：物件名稱、地址、坪數、格局、租金、押金等\n• 草稿自動儲存功能 (form_drafts 表格)\n• 表單驗證與錯誤提示\n• 照片上傳整合\n• Server Action 資料提交\n\n【技術難點】\n• 已解決：草稿與正式提交的狀態管理\n• 已解決：Schema Mismatch 問題\n\n【下階段計畫】\n• 地址自動完成功能\n• 地圖定位整合"
      },
      {
          name: "房東新增物件方式2－自動填入 (VLM/OCR)",
          percentage: 95,
          docPath: "/project-process/features/vlm-ocr-system.html",
          category: "房東 (Landlord)",
          ...
          devLog: "【完成項目】\n• Python OCR Service 完成 (FastAPI + uvicorn)\n• 多 VLM 提供者支援: Claude, GPT-4V, Gemini\n• VLMDocumentUpload 前端元件\n• ParsedResultPreview 校對介面\n• API Key 管理功能 (VLMApiKeyDrawer)\n• 文件上傳與處理流程完整實作\n\n【技術難點】\n• 已解決：多提供者 API 統一介面\n• 已解決：PDF 多頁處理\n• 辨識準確率達 92%+\n\n【下階段計畫】\n• 繼續優化辨識準確率\n• 增加更多文件類型支援"
      },
      {
          name: "房東的預約看房管理功能",
          percentage: 0,
      ...
      {
          name: "房東 - 溝通介面整合 (Landlord Integrations)",
          percentage: 0,
          docPath: "",
          category: "房東 (Landlord)",
          ...
          lastModifiedBy: "Antigravity",
          lastModifiedDate: "2026/02/12",
          acceptanceCriteria: "1. 基於 #079 通用通訊核心系統實作。\n2. 需支援依照「物件」或「租客」進行對話分組。\n3. 整合租客維修申請單的自動對話群組。\n4. 提供房東專用的自動回覆設定。\n5. 支援批次發送公告給特定物件的所有租客。",
          devLog: ""
      },
      {
      ...
      // ===== 租客 (Tenant) - 063~067 =====
      {
          name: "租客(已簽約)-儀表板",
          percentage: 92,
          docPath: "/project-process/features/tenant-dashboards-20260206.html",
          category: "租客 (Tenant)",
          startDate: "2026-03-01", endDate: "2026-03-06", owner: "Dev Team", points: 5,
          lastModifiedBy: "GitHub Copilot",
          lastModifiedDate: "2026/02/11",
          acceptanceCriteria: "1. 登入後首頁需顯示目前租約狀態與剩餘租期。\n2. 需顯示下期租金金額與繳費截止日。\n3. 需提供快速報修入口。\n4. 需顯示房東或管理員發布的重要公告。\n5. 介面需整合近期繳費紀錄概覽。",
          devLog: "【完成項目】\n• Contracted Tenant Dashboard 頁面架構\n• KPI 卡片：租約狀態、剩餘租期、下期租金\n• 快速報修入口按鈕\n• 響應式設計完成\n• 與其他角色 Dashboard 共用元件\n\n【技術難點】\n• 多角色儀表板切換時的狀態同步\n\n【下階段計畫】\n• 整合繳費紀錄顯示\n• 公告系統開發"
      },
      {
          name: "租客(潛在)-儀表板",
          percentage: 92,
          ...
          devLog: "【完成項目】\n• Potential Tenant Dashboard 頁面架構\n• 收藏物件狀態顯示\n• 最近瀏覽紀錄元件\n• 個人資料完整度提示\n• 響應式設計\n\n【技術難點】\n• 物件推薦演算法待實作\n\n【下階段計畫】\n• 物件推薦系統開發\n• 預約看房行程表整合"
      },
      {
          name: "租客的維修申請",
          percentage: 0,
      ...
      {
          name: "租客 - 溝通介面整合 (Tenant Integrations)",
          percentage: 0,
          docPath: "",
          category: "租客 (Tenant)",
      ...
      // ===== 通用/系統 (General/System) - 073~084 =====
      {
          ...
          devLog: "【完成項目】\n• Header 暗/亮模式切換按鈕\n• Tailwind CSS dark: 前綴全面支援\n• localStorage 偏好設定儲存\n• 系統主題偵測 (prefers-color-scheme)\n• 所有 UI 元件暗模式適配\n\n【技術難點】\n• 已解決：SSR hydration mismatch 問題\n\n【已結案】功能開發完成"
      },
      {
          name: "RWD網頁響應式設計",
          percentage: 85,
          ...
          devLog: "【完成項目】\n• Tailwind CSS 響應式斷點配置\n• Mobile Hamburger Menu 實作\n• 主要頁面 RWD 適配完成\n• 表格水平捲動設計\n• 觸控友善按鈕尺寸\n\n【技術難點】\n• 複雜表格在小螢幕的呈現方式優化中\n\n【下階段計畫】\n• 部分管理後台頁面 RWD 優化\n• Google Mobile-Friendly 測試驗證"
      },
      {
          name: "使用者身份驗證系統",
          percentage: 95,
          docPath: "/project-process/features/auth-system.html",
          category: "通用/系統 (General/System)",
          startDate: "2026-02-10", endDate: "2026-02-18", owner: "Dev Team", points: 8,
          lastModifiedBy: "GitHub Copilot",
          lastModifiedDate: "2026/02/11",
          ...
          devLog: "【完成項目】\n• Supabase Auth 完整整合\n• Email/Password 註冊與登入\n• OAuth: Google 登入已完成\n• 密碼複雜度驗證\n• Session 管理與自動刷新\n• Next.js Middleware 認證檢查\n• 跨 App 認證同步 (Transfer Token)\n\n【技術難點】\n• 已解決：跨 App session 同步問題\n• 已解決：Middleware 認證效能優化\n\n【下階段計畫】\n• Facebook OAuth 整合 (待評估需求)"
      },
      {
      ...
      },
      {
          ...
          devLog: "【完成項目】\n• Login 頁面 UI 完成 (深色主題設計)\n• Email/Password 輸入表單\n• 忘記密碼連結\n• 註冊帳號連結\n• 表單驗證與錯誤提示\n• Tab/Enter 鍵盤支援\n• Supabase Auth 整合\n\n【技術難點】\n• 已解決：錯誤訊息安全性處理\n\n【已結案】功能開發完成"
      },
      {
          name: "使用者登入頁面-記住我功能",
          percentage: 100,
          docPath: "/project-process/features/remember-me-tdd-report-20260205.html",
          category: "通用/系統 (General/System)",
          ...
          devLog: "【完成項目】\n• Remember Me 勾選框 UI\n• Supabase Session 持久化設定\n• Token 有效期: 14 天\n• 登出時完整清除 session\n• TDD 開發，測試覆蓋率 100%\n\n【技術難點】\n• 已解決：跨 App session 同步\n\n【已結案】功能開發完成，TDD 報告已產出"
      },
      {
          name: "使用者密碼重設頁面",
          percentage: 95,
          ...
          devLog: "【完成項目】\n• Forgot Password 頁面 UI\n• Email 輸入與發送重設連結\n• Update Password 頁面\n• 密碼複雜度驗證\n• Supabase Auth 重設流程整合\n\n【技術難點】\n• 已解決：重設後強制登出其他裝置\n\n【下階段計畫】\n• 強化 Email 枚舉防護"
      },
      {
          name: "通用通訊系統核心 (Universal Communication System Core)",
          percentage: 0,
          docPath: "",
          category: "通用/系統 (General/System)",
          startDate: "2026-03-06", endDate: "2026-03-09", owner: "Dev Team", points: 8,
          lastModifiedBy: "Antigravity",
          lastModifiedDate: "2026/02/12",
          acceptanceCriteria: "1. 建立統一的後端通訊架構(WebSocket/Realtime DB)。\n2. 設計標準化的前端對話元件(Chat UI Component)供各角色共用。\n3. 實作全域通知系統(Global Notification System)。\n4. 支援多媒體檔案傳輸與儲存管理。\n5. 需具備擴充性，支援未來新增的 User Roles。",
          devLog: ""
      },
      {
          name: "受邀使用者登入介面",
      ...
      },
      {
          ...
          devLog: "【完成項目】\n• VLM OCR Service 完整運行\n• 支援格式: JPG, PNG, PDF\n• 多 VLM 提供者: Claude, GPT-4V, Gemini\n• 辨識欄位: 地號、建號、所有權人、地址、面積\n• ParsedResultPreview 校對介面\n• 辨識準確率 > 90%\n\n【技術難點】\n• 已解決：多頁 PDF 處理\n• 已解決：不同格式謄本的適配\n\n【下階段計畫】\n• 敏感個資自動遮蔽功能"
      },
      {
          name: "上傳物件照片功能",
          percentage: 95,
          docPath: "/project-process/features/photo-upload.html",
          category: "通用/系統 (General/System)",
          startDate: "2026-03-20", endDate: "2026-03-23", owner: "Dev Team", points: 3,
          lastModifiedBy: "GitHub Copilot",
          lastModifiedDate: "2026/02/11",
          acceptanceCriteria: "1. 支援多張照片批次上傳。\n2. 上傳前需在前端進行壓縮與格式檢查。\n3. 需提供拖拉(Drag & Drop)上傳介面。\n4. 上傳後需可調整照片順序與設定封面圖。\n5. 需顯示上傳進度條與失敗重試機制。",
          devLog: "【完成項目】\n• PropertyPhotoUpload 元件完成\n• 多檔案批次上傳支援\n• Drag & Drop 介面\n• 前端圖片壓縮 (browser-image-compression)\n• HEIC 格式轉換支援 (heic2any)\n• 進度條顯示\n• Supabase Storage 整合\n\n【技術難點】\n• 已解決：HEIC 轉換效能優化\n• 已解決：大檔案分片上傳\n\n【下階段計畫】\n• 照片順序調整 UI\n• 封面圖設定功能"
      },

      // ===== 金流支付 (Payments) - 085~089 =====
      {
      ...
      // ===== 測試與品質保證 (Testing & QA) - 090 =====
      {
          ...
          devLog: "【完成項目】\n• TDD 開發流程完整實作\n• Jest 單元測試案例: 15+ 個\n• 測試覆蓋率: 100%\n• 成功/失敗路徑全覆蓋\n• HTML 測試報告自動生成\n• CI/CD 整合\n\n【技術難點】\n• 已解決：Mock Supabase Auth 測試\n\n【已結案】TDD 報告已完成並發布"
      },

      // ===== 資料庫與後端架構 (Database & Backend Infrastructure) - 091~095 =====
      {
          name: "Supabase 資料庫架構與遷移",
          percentage: 98,
          docPath: "/project-process/progress-reports/database-reports/supabase-schema-status.md",
          ...
          devLog: "【完成項目】\n• 30+ 個 Migration 檔案完成\n• 核心表格: users_profile, properties, property_photos, leases 等\n• IAM 系統: roles, permissions, role_permissions, user_roles\n• RLS 策略全面部署\n• 效能索引建立完成\n• Supabase Local Dev 環境配置\n\n【技術難點】\n• 已解決：RLS 遞迴策略效能問題\n• 已解決：多角色權限交叉驗證\n\n【下階段計畫】\n• 定期 Schema 優化審查"
      },
      {
          name: "Supabase 認證與授權系統",
          percentage: 92,
          docPath: "/project-process/progress-reports/auth-reports/supabase-auth-status.md",
          category: "資料庫與後端架構 (Database & Backend Infrastructure)",
          ...
          devLog: "【完成項目】\n• Email/Password 認證完成\n• Google OAuth 整合\n• Next.js Middleware Session 驗證\n• RBAC 權限系統 (5+ 角色定義)\n• Transfer Token 跨 App 認證\n• 密碼重設流程\n• Email 驗證流程\n\n【技術難點】\n• 已解決：跨 App session 同步\n• 已解決：多角色切換邏輯\n\n【下階段計畫】\n• Mobile App 認證同步優化"
      },
      {
          name: "Supabase 儲存空間 (Storage) 整合",
          percentage: 90,
          docPath: "/project-process/progress-reports/storage-reports/supabase-storage-status.md",
          category: "資料庫與後端架構 (Database & Backend Infrastructure)",
          ...
          devLog: "【完成項目】\n• property-photos Bucket 建立並配置 RLS\n• property-documents Bucket 建立\n• PropertyPhotoUpload 元件 (Drag & Drop)\n• 前端圖片壓縮 (browser-image-compression)\n• HEIC 轉換支援\n• Python OCR Service 文件處理整合\n\n【技術難點】\n• 已解決：大檔案上傳效能\n• 已解決：Storage RLS 配置\n\n【下階段計畫】\n• CDN 快取策略優化"
      },
      {
      ...
      },
      {
          ...
          devLog: "【完成項目】\n• Edge Functions 環境評估\n• 初步開發環境配置\n\n【技術難點】\n• Edge Functions 與現有 Python 服務的整合策略\n• Cold Start 效能優化\n\n【下階段計畫】\n• Edge Functions 開發環境完整建置\n• 範例 Function 開發與測試\n• 部署流程文件化"
      }
  ]
};

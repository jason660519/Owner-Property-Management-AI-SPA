...
| 風險項目                           | 影響 | 機率 | 緩解措施                                           |
| ---------------------------------- | ---- | ---- | -------------------------------------------------- |
| Policy 邏輯錯誤導致資料洩漏        | 嚴重 | 中   | 1. 完整測試覆蓋2. Code Review3. 分階段上線 |
| 複雜 Policy 影響查詢效能           | 高   | 中   | 1. 建立適當索引2. 效能基準測試3. 查詢優化  |
| 函數 SECURITY DEFINER 權限提升風險 | 嚴重 | 低   | 1. 最小權限原則2. 輸入驗證3. 定期稽核      |
| 授權表資料不一致                   | 中   | 低   | 1. 外鍵約束2. 觸發器驗證3. 定期清理        |

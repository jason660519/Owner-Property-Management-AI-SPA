...
window.ROADMAP_DATA = {
    ...
    features: [
        // 超級管理員
        { name: "超級管理員-儀表板", percentage: 90, docPath: "../features/admin-dashboard-20260206.html", category: "超級管理員 (Super Admin)", points: 8, lastModifiedBy: "Gemini-3-Pro-Preview", lastModifiedDate: "2026/02/06" },
        ...
        { name: "超級管理員-資料庫Supabase管理功能", percentage: 0, docPath: "../progress-reports/database-reports/supabase-auth-integration-guide.md", category: "超級管理員 (Super Admin)", points: 5, lastModifiedBy: "", lastModifiedDate: "" },
        ...
        // 買家
        { name: "買家(已簽約)-儀表板", percentage: 50, docPath: "../features/buyer-dashboard-mock-20260206.html", category: "買家 (Buyer)", points: 5, lastModifiedBy: "Gemini-3-Pro-Preview", lastModifiedDate: "2026/02/06" },
        ...
        // 公司首頁與產品
        { name: "公司首頁", percentage: 80, docPath: "../features/company-homepage.html", category: "公司頁面 (Company Pages)", points: 5, lastModifiedBy: "", lastModifiedDate: "" },
        { name: "公司產品費用說明頁", percentage: 0, docPath: "", category: "公司頁面 (Company Pages)", points: 2, lastModifiedBy: "", lastModifiedDate: "" },
        { name: "公司產品Q&A+Need Help頁", percentage: 0, docPath: "", category: "公司頁面 (Company Pages)", points: 2, lastModifiedBy: "", lastModifiedDate: "" },
        { name: "公司產品教學", percentage: 0, docPath: "", category: "公司頁面 (Company Pages)", points: 3, lastModifiedBy: "", lastModifiedDate: "" },
        { name: "聯絡我們>發送訊息功能", percentage: 100, docPath: "../features/daily-report-20260205.html", category: "公司頁面 (Company Pages)", points: 3, lastModifiedBy: "Gemini-3-Pro-Preview", lastModifiedDate: "2026/02/05-14:30" },
        ...
        // 房東
        { name: "房東-儀表板", percentage: 90, docPath: "../features/landlord-dashboard-status-20260206.html", category: "房東 (Landlord)", points: 8, lastModifiedBy: "Gemini-3-Pro-Preview", lastModifiedDate: "2026/02/06" },
        ...
        // 租客
        { name: "租客(已簽約)-儀表板", percentage: 90, docPath: "../features/tenant-dashboards-20260206.html", category: "租客 (Tenant)", points: 5, lastModifiedBy: "Gemini-3-Pro-Preview", lastModifiedDate: "2026/02/06" },
        { name: "租客(潛在)-儀表板", percentage: 90, docPath: "../features/tenant-dashboards-20260206.html", category: "租客 (Tenant)", points: 5, lastModifiedBy: "Gemini-3-Pro-Preview", lastModifiedDate: "2026/02/06" },
        ...
        { name: "使用者身份驗證系統", percentage: 90, docPath: "../features/auth-system.html", category: "通用/系統 (General/System)", points: 8, lastModifiedBy: "Claude Sonnet 4.5", lastModifiedDate: "2026/02/05" },
        { name: "註冊的使用者都有自己的行事曆管理頁面", percentage: 0, docPath: "", category: "通用/系統 (General/System)", points: 3, lastModifiedBy: "", lastModifiedDate: "" },
        { name: "使用者登入頁面", percentage: 100, docPath: "../features/auth-system.html", category: "通用/系統 (General/System)", points: 3, lastModifiedBy: "Claude Sonnet 4.5", lastModifiedDate: "2026/02/05" },
        { name: "使用者登入頁面-記住我功能", percentage: 100, docPath: "../features/remember-me-tdd-report-20260205.html", category: "通用/系統 (General/System)", points: 2, lastModifiedBy: "Claude Sonnet 4.5", lastModifiedDate: "2026/02/05" },
